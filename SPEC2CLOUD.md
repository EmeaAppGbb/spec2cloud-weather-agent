---
title: Weather Agent # Limit to 40 chars or less; be extremely concise
description: AI App that shows dummy weather information using AI Foundry, Microsoft Agent Framework, MCP tools and Container Apps # Summary with 140 chars or less; be extremely concise. Use the README in the repo to provide the full description.
...
thumbnail: architecture.png # (optional) Full URL or relative path with an image with 16:9 aspect ratio: 1280 × 720 (HD), 1920 × 1080 (Full HD)
